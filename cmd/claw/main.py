"""Single-run entry point for the DeepSeek Provider experiment."""
...
class MockRegistry(Registry):
    """Provide the deterministic weather tool required by the experiment."""
